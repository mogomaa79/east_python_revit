...
class Villa:
    ...
    def nearest_bdist(self, x, y):
        return min(self.rectangle1.nearest_bdist(x, y), self.rectangle2.nearest_bdist(x, y), self.rectangle3.nearest_bdist(x, y), self.rectangle4.nearest_bdist(x, y), self.triangle.nearest_bdist(x, y))
